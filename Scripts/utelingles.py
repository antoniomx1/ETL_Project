...
import csv
import time
from configdiez import conexiones_esquemas
from concurrent.futures import ThreadPoolExecutor
from drive_upload import subir_o_actualizar_archivo

# Ruta al archivo SQL con el query
ruta_sql_file = "C:/Users/jvelazhe/Desktop/Moodle_Replicas/SQL_Querys/utelingles.sql"
...
output_file = "C:/Users/jvelazhe/Desktop/Moodle_Replicas/Load/examenutelingles.csv"
...
subir_o_actualizar_archivo(
    nombre_archivo='examenutelingles.csv',
    ruta_archivo= output_file,
    carpeta_id='1XTCW36Q1e8MXk3SNo3RDWn5_vqAHRZH5'
)
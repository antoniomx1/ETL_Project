...
ruta_sql_file = "C:/Users/jvelazhe/Desktop/Moodle_Replicas/SQL_Querys/respuestascolaborativo.sql"
ruta_sql_file2 = "C:/Users/jvelazhe/Desktop/Moodle_Replicas/SQL_Querys/respuestascyc2.sql"
...
output_file = "C:/Users/jvelazhe/Desktop/Moodle_Replicas/Load/respuestascolaborativo.csv"
...
def ejecutar_query_concurrente(conexion_esquema, query):
    ...
    query_con_categoria = query + ' (' + categorias + ')'+ query2  if categorias else query
    try:
...
subir_o_actualizar_archivo(
    nombre_archivo='respuestascolaborativo.csv',

...
sheet = gc.open_by_key('1j9Du2mnKXR-LRLK4Vzn9MofGHzONx0GXiI5TUaKfRgc')
...
opacad.to_csv('C:/Users/jvelazhe/Desktop/Sabana_NR_Retencion/opacademicab.csv', index=False, encoding='latin-1')
opacad.to_csv('G:/Mi unidad/Source/opacademicab.csv', index=False, encoding='latin-1')

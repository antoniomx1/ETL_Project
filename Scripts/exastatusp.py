...
ruta_sql_file = "C:/Users/jvelazhe/Desktop/Moodle_Replicas/SQL_Querys/exastatlic1.sql"
ruta_sql_file2 = "C:/Users/jvelazhe/Desktop/Moodle_Replicas/SQL_Querys/exastatlic2.sql"
ruta_sql_file3 = "C:/Users/jvelazhe/Desktop/Moodle_Replicas/SQL_Querys/exastatlic3.sql"
# Ruta al archivo CSV con las categorías
categorias_file = "C:/Users/jvelazhe/Desktop/Moodle_Replicas/idcategorys/idcategoryP.csv"

# Carpeta de salida para los archivos CSV
output_folder = "C:/Users/jvelazhe/Desktop/Moodle_Replicas/Output/exastatusposgra/"
...
def ejecutar_query_concurrente(conexion_esquema, query):
    ...
    query_con_categoria = query + ' (' + categorias + ')' + query2 + ' (' + categorias + ')'  + query3       if categorias else query
...
with open(ruta_sql_file3, 'r', encoding='latin1') as archivo_sql3:
    query3 = archivo_sql3.read().strip()    

...
ruta_sql_file = "C:/Users/jvelazhe/Desktop/Moodle_Replicas/SQL_Querys/idgrupos.sql"
...
output_folder = "C:/Users/jvelazhe/Desktop/Moodle_Replicas/output/idgrupos/"
...
def ejecutar_query(conexion_esquema, query):
    ...
    with open(f'{output_folder}{conexion_esquema["nombre"]}.csv', 'w', newline='', encoding='utf-8') as csvfile:

...
import csv
import time
from config111mas import conexiones_esquemas
from concurrent.futures import ThreadPoolExecutor
from drive_upload import subir_o_actualizar_archivo

# Ruta al archivo SQL con el query
ruta_sql_file = "C:/Users/jvelazhe/Desktop/Moodle_Replicas/SQL_Querys/accprofP.sql"

# Ruta al archivo CSV con las categorías
categorias_file = "C:/Users/jvelazhe/Desktop/Moodle_Replicas/idcategorys/idcategoryantep.csv"

# Ruta al archivo de salida consolidado
output_file = "C:/Users/jvelazhe/Desktop/Moodle_Replicas/Load/accprofp.csv"
...
subir_o_actualizar_archivo(
    nombre_archivo='Acc_ProfPosgraSepOct24.csv',
